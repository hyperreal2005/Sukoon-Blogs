    ...
    return (
        <>
            <nav className="navbar">
                ...
                <div className={"absolute bg-white w-full left-0 top-full mt-0.5 border-b border grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 and p-0 md:w-auto md:show " + (searchBoxVisibility ? "show" : "hide")}>
                    <input type="text" 
                    placeholder="Search"
